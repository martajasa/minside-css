...
Minimal, elegant, component-based CSS framework for personal and professional projects.

Minside CSS is a lightweight front-end framework built with clarity and consistency in mind.  
Designed for developers who want structured components without unnecessary complexity.
...
- Utility-first helpers (spacing, flex, opacity, borders, colors)
...
● Lists
● Alerts
● Utilities (flex, spacing, borders, opacity, colors, etc.)
...
✅ Components over scattered utilities
...
✔ Served locally
✔ Hosted inside subfolder of another domain
...
1. Edit dist/minside.css
2. Edit dist/minside.js
3. Update docs
4. Commit changes
...
Created by Armin Martajasa
GitHub: https://github.com/martajasa
